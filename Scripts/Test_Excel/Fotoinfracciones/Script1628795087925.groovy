...
for (def rowNum = 1; rowNum <= findTestData('ExcelFInfracciones').getRowNumbers(); rowNum++) {
    WebUI.setText(findTestObject('Repo_Cobros/Page_Sistema de Control Vehicular/input_Placa_vchPlacaConsulta'), findTestData(
            'ExcelFInfracciones').getValue(1, rowNum))
    ...
    WebUI.setText(findTestObject('Repo_Cobros/Page_Sistema de Control Vehicular/Page_Sistema de Control Vehicular/input_Folio Infraccion_iFolioInfraccion'), 
        findTestData('ExcelFInfracciones').getValue(2, rowNum))
